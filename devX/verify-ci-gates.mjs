...
const probes = [
  ...
  ...["codebases/engine/rps", "codebases/backend/api", "codebases/backend/worker", "codebases/frontend/web", "codebases/devtools/sms-inbox", "codebases/devtools/registry-mock", "codebases/devtools/event-simulator"].map((workspace) => ({
