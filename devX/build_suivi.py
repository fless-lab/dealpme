...
PROGRESS = {
    ...
    "Modèle de données socle": ("Complétée", None, dt.date(2026, 9, 4)),
    "Modèle Deal et AssetDealDetail": ("Complétée", None, dt.date(2026, 9, 7)),
    "Classification des champs": ("En cours", 0.7, None),
    "Enregistrement d'attribution immuable": ("Complétée", None, dt.date(2026, 9, 8)),
    ...
    "Rôles et permissions évalués côté serveur": ("Complétée", None, dt.date(2026, 9, 9)),
    "Gestion de session": ("En cours", 0.7, None),
    "Consentements séparés": ("Complétée", None, dt.date(2026, 9, 7)),
    "Paliers d'abonnement": ("En cours", 0.5, None),
    "Workflow de confirmation d'adhésion": ("En cours", 0.8, None),
    "Vérification RCCM / CFE": ("En cours", 0.7, None),
    "RegistryRecord stocké séparément": ("Complétée", None, dt.date(2026, 9, 7)),
    "Modèle Certification": ("Complétée", None, dt.date(2026, 9, 8)),
    "Workflow de décision nominative": ("Complétée", None, dt.date(2026, 9, 9)),
    "Badge Deal-Ready : affichage": ("En cours", 0.6, None),
    ...
    "Calcul de fourchette indicative": ("Complétée", None, dt.date(2026, 9, 8)),
    "Mentions 'indicative, non opposable'": ("Complétée", None, dt.date(2026, 9, 8)),
    ...
    "Mots de passe de démonstration uniques": ("Complétée", None, dt.date(2026, 9, 10)),
    ...
    "En-têtes de sécurité HTTP": ("Complétée", None, dt.date(2026, 9, 9)),
}
