...
add("V2", "TRV", "Conception", "Registre d'interactions du dépôt : reprise des identifiants officiels sur les surfaces couvertes, extension au même format pour les autres, contrat par contrôle (déclencheur, autorisation, source, succès, blocage, audit)", "Aucun contrôle visible sans contrat vérifiable ; couverture produite en preuve de recette", 5, "Haute", bloquant="Oui", dep="Décision A15")
