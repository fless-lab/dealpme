...
PROGRESS = {
    ...
    "Modèle Deal et AssetDealDetail": ("Complétée", None, dt.date(2026, 9, 10)),
    "Classification des champs": ("En cours", 0.7, None),
    "Enregistrement d'attribution immuable": ("Complétée", None, dt.date(2026, 9, 10)),
    ...
    "Rôles et permissions évalués côté serveur": ("Complétée", None, dt.date(2026, 9, 10)),
    ...
    "Workflow de décision nominative": ("Complétée", None, dt.date(2026, 9, 10)),
    ...
    "Tests automatisés": ("En cours", 0.35, None),
