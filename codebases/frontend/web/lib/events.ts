export interface ManagedEvent {
  ...
  registrations?:{id:string;displayName:string;consentContactAt:string|null;joinedAt:string|null}[];
...
export const EVENT_STATE:Record<string,string>={DRAFT:"Brouillon",PUBLISHING:"Publication en cours",PUBLISHED:"Publié",SYNC_UNKNOWN:"Synchronisation à rapprocher",CANCEL_PENDING:"Annulation à confirmer",CANCELLED:"Annulé",CLOSED:"Clôturé"};
