...
export function AppointmentDecision({id,status}:{id:string;status:string}){
  const router=useRouter(),[reason,setReason]=useState(""),[busy,setBusy]=useState(false),[error,setError]=useState<string|null>(null);
